  ...
  return (
    <>
      <div
        ...
        className={
          open
            ? "md:hidden fixed z-40 top-0 h-screen p-10 overflow-y-auto w-80 bg-gradient-to-r to-pink-500 from-purple-400 transition-all duration-500 ease-in-out"
            : "hidden"
        }
        tabindex="-1"
      ...
      >
        ...
        <button
          ...
          className="text-white bg-transparent hover:bg-pinktruck rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center"
        >
          <svg
            aria-hidden="true"
            className="w-5 h-5"
        ...
        <div className="absolute bottom-10">
          <div className="flex flex-col ">
            <div className="flex mt-4 space-x-3 mb-5">
              <a
                href="https://www.facebook.com/profile.php?id=100087267520227&mibextid=LQQJ4d"
              ...
              <a
                href="https://instagram.com/delicream_2022?igshid=YmMyMTA2M2Y="
                className="text-white hover:text-white"
              >
                <svg
                  className="w-7 h-7"
